...
$toolkit.showInstructions("This test blinks some LEDs and you would be asked to answer whether you see the 
same LED pattern on the board as is shown in the console.");

$toolkit.showInstructions("X means that the LED is on and - means that the LED is off. \r\n
