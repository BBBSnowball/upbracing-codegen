...
public class TestStateTransitions {
	...
	Messages[] message = new Messages[15];
	MCUConfiguration[] config = new MCUConfiguration[15];
	Validator[] validator = new Validator[15];
	...
	public void test() {
		...
		assertEquals(
				TestHelpers
						.loadResource("expected_results/statemachines/ExpectedTransitionTestResults.txt"),
				sb.toString());
		...
		assertEquals(
				TestHelpers
						.loadResource("expected_results/statemachines/expectedTransitionTestResults_1.txt"),
				sb.toString());
		...
		assertEquals(
				TestHelpers
						.loadResource("expected_results/statemachines/expectedTransitionTestResults_2.txt"),
				sb.toString());
		...
		assertEquals(
				TestHelpers
						.loadResource("expected_results/statemachines/expectedTransitionTestResults_3.txt"),
				sb.toString());
		...
		assertEquals(
				TestHelpers
						.loadResource("expected_results/statemachines/expectedTransitionTestResults_4.txt"),
				sb.toString());
		...
		assertEquals(
				TestHelpers
						.loadResource("expected_results/statemachines/expectedTransitionTestResults_5.txt"),
				sb.toString());
		...
		assertEquals(
				TestHelpers
						.loadResource("expected_results/statemachines/expectedTransitionTestResults_6.txt"),
				sb.toString());
