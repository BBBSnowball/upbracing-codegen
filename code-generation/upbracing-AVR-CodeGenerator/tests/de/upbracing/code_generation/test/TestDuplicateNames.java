...
public class TestDuplicateNames {
	...
	public void testDuplicateNames() {
		...
		assertEquals(TestHelpers.loadResource("/expected_results/statemachines/expectedDuplicateNameResults_1.txt"),
		sb.toString());
		...
		assertEquals(TestHelpers.loadResource("/expected_results/statemachines/expectedDuplicateNameResults_2.txt"),
				sb.toString());
		...
		assertEquals(TestHelpers.loadResource("/expected_results/statemachines/expectedDuplicateNameResults_3.txt"),
				sb.toString());
		...
		assertEquals(TestHelpers.loadResource("/expected_results/statemachines/expectedDuplicateNameResults_4.txt"),
				sb.toString());
		...
		assertEquals(TestHelpers.loadResource("/expected_results/statemachines/expectedDuplicateNameResults_5.txt"),
				sb.toString());
