...
public class TestCollapseFinalStates {
	...
	public void test() {
		...
		assertEquals(
				TestHelpers
						.loadResource("/expected_results/statemachines/collapsibleFinalStates_1.txt"),
				sb.toString());
		...
		assertEquals(TestHelpers
				.loadResource("/expected_results/statemachines/collapsibleFinalStates_2.txt"),
				sb.toString());
		...
		assertEquals(TestHelpers
				.loadResource("/expected_results/statemachines/collapsibleFinalStates_4.txt"),
				sb.toString());
		...
		assertEquals(TestHelpers
				.loadResource("/expected_results/statemachines/collapsibleFinalStates_3.txt"),
				sb.toString());
	}
