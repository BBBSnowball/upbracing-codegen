...
public class TestAssignNames {
	...
	public void testAssignNames() {
		...
		assertEquals(TestHelpers.loadResource("expected_results/statemachines/expectedAssignedNames_1.txt"), sb.toString());
		...
		assertEquals(TestHelpers.loadResource("expected_results/statemachines/expectedAssignedNames_2.txt"), sb.toString());
		...
		assertEquals(TestHelpers.loadResource("expected_results/statemachines/expectedAssignedNames_3.txt"), sb.toString());
		...
		assertEquals(TestHelpers.loadResource("expected_results/statemachines/expectedAssignedNames_4.txt"), sb.toString());
	}
}
